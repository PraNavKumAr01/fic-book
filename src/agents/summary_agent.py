...
class ChapterSummaryAgent:
    ...
    def generate_chapter_summary(self, chapter_content: str, previous_summary: str) -> str:
        messages = [
            ...
            {
                "role": "user",
                "content": f"Here is the current chapter content : {chapter_content}, and this is the previous chapter summary : {previous_summary} (If this is None then assume it is the first chapter)"
            }
        ]
